...
S(id='CASE-2026-08-0013', name='NGUYEN VAN TUAN', employer='새터농장',
  period=('2026-08-01', '2026-08-31'), payment_date='2026-09-05',
  contract=C(ct_employee_name='NGUYEN VAN TUAN', ct_employer_name='새터농장',
...
S(id='CASE-2026-09-0014', name='PRAKASH GURUNG', employer='청산영농조합법인',
  period=('2026-09-01', '2026-09-30'), payment_date='2026-10-10',
  contract=C(ct_employee_name='PRAKASH GURUNG', ct_employer_name='청산영농조합법인',
...
S(id='CASE-2026-09-0015', name='SOMSAK BOONMEE', employer='금빛과수원',
  period=('2026-09-01', '2026-09-30'), payment_date='2026-10-05',
  contract=C(ct_employee_name='SOMSAK BOONMEE', ct_employer_name='금빛과수원',
...
S(id='CASE-2026-08-0016', name='AZIZBEK RASULOV', employer='너른들농장',
  period=('2026-08-01', '2026-08-31'), payment_date='2026-09-10',
  contract=C(ct_employee_name='AZIZBEK RASULOV', ct_employer_name='너른들농장',
...
S(id='CASE-2026-09-0017', name='MARIA CLARA REYES', employer='참빛농산',
  period=('2026-09-01', '2026-09-30'), payment_date='2026-10-10',
  contract=C(ct_employee_name='MARIA CLARA REYES', ct_employer_name='참빛농산',
...
S(id='CASE-2026-10-0018', name='BATTULGA ENKH', employer='소백산농원',
  period=('2026-10-01', '2026-10-20'), payment_date='2026-11-10',
  contract=C(ct_employee_name='BATTULGA ENKH', ct_employer_name='소백산농원',
...
S(id='CASE-2026-10-0019', name='KHIN MYAT AUNG', employer='물레방아농장',
  period=('2026-10-01', '2026-10-31'), payment_date='2026-11-10',
  contract=C(ct_employee_name='KHIN MYAT AUNG', ct_employer_name='물레방아농장',
...
S(id='CASE-2026-11-0020', name='PHOUVONG SISOMBAT', employer='다산딸기농원',
  period=('2026-11-01', '2026-11-30'), payment_date='2026-12-04',
  contract=C(ct_employee_name='PHOUVONG SISOMBAT', ct_employer_name='다산딸기농원',
...
S(id='CASE-2026-11-0021', name='ZHANG XIULAN', employer='서해뜰영농조합',
  ps_name='ZANG XIULAN',                                       # R00 이름 불일치
  period=('2026-11-01', '2026-11-30'), payment_date='2026-12-10',
  worker_confirmed=False,                                      # R10 REVIEW
  contract=C(ct_employee_name='ZHANG XIULAN', ct_employer_name='서해뜰영농조합',
...
S(id='CASE-2026-08-0022', name='RIZKY PRATAMA', employer='초원목장농장',
  period=('2026-08-01', '2026-08-31'), payment_date='2026-09-10',
  contract=C(ct_employee_name='RIZKY PRATAMA', ct_employer_name='초원목장농장',
...
S(id='CASE-2026-09-0023', name='NURLAN ABDYKADYR', employer='백학농원',
  period=('2026-09-01', '2026-09-30'), payment_date='2026-10-10',
  contract=C(ct_employee_name='NURLAN ABDYKADYR', ct_employer_name='백학농원',
...
S(id='CASE-2026-09-0024', name='DO THI LAN', employer='가온들녘농장',
  period=('2026-09-01', '2026-09-30'), payment_date='2026-10-10',
  account_holder='DO VAN HUNG',                                # R00 배우자 계좌
  contract=C(ct_employee_name='DO THI LAN', ct_employer_name='가온들녘농장',
...
S(id='CASE-2026-10-0025', name='KAMAL HOSSAIN', employer='오름농장',
  period=('2026-10-01', '2026-10-31'), payment_date='2026-11-05',
  contract=C(ct_employee_name='KAMAL HOSSAIN', ct_employer_name='오름농장',
...
S(id='CASE-2026-10-0026', name='JOAO DA COSTA', employer='별뜨락농원',
  period=('2026-10-01', '2026-10-31'), payment_date='2026-11-10',
  record_available=False,
  contract=C(ct_employee_name='JOAO DA COSTA', ct_employer_name='별뜨락농원',
             ct_wage_type='monthly', ct_wage_amount=2300000, ct_monthly_work_hours=176.0,
             ct_overtime_hourly_pay=19602, ct_weekly_allowance_included=True,
             ct_housing_provided=True, ct_housing_cost=100000,
...
S(id='CASE-2026-08-0027', name='WANIDA SRIPRAI', employer='강마을농산',
  period=('2026-08-01', '2026-08-31'), payment_date='2026-09-10',
  contract=C(ct_employee_name='WANIDA SRIPRAI', ct_employer_name='강마을농산',
...
S(id='CASE-2026-09-0028', name='SUNIL PERERA', employer='해오름농장',
  period=('2026-09-01', '2026-09-30'), payment_date='2026-10-10',
  contract=C(ct_employee_name='SUNIL PERERA', ct_employer_name='해오름농장',
...
S(id='CASE-2026-11-0030', name='BIBEK ADHIKARI', employer='배꽃마을농장',
  period=('2026-11-01', '2026-11-30'), payment_date='2026-12-10',
  contract=C(ct_employee_name='BIBEK ADHIKARI', ct_employer_name='배꽃마을농장',
  ...
  transactions=[
      dict(datetime='2026-11-14 12:00:00', record='BIBEK ADHIKARI', content='타행이체',
           memo='본인 계좌 이체', amount=50000, salary=False),
  ],
  inquiry=('2026-11-01', '2026-12-31'))

# 0031 몽골 / 시설재배 / 연말~연초 걸침 — R02, R05, R06, R09, R11
S(id='CASE-2026-12-0031', name='OYUNAA TSEREN', employer='늘봄영농조합',
  period=('2026-12-16', '2027-01-15'), payment_date='2027-01-25',
  contract=C(ct_employee_name='OYUNAA TSEREN', ct_employer_name='늘봄영농조합',
